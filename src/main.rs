...
fn raw_key_bindings() -> HashMap<String, Box<dyn KeyEventHandler<RustConn>>> {
    let mut raw_bindings = map! {
        ...
        "M-q" => modify_with(action::close_current_client),
        "M-Tab" => modify_with(action::switch_tag),
        "M-x" => modify_with(action::move_to_next_screen),
        "M-S-x" => modify_with(action::move_current_client_to_next_screen),
